...
try { await db.execute({ sql: `ALTER TABLE dossiers ADD COLUMN master_cv TEXT`, args: [] }); console.log('Added master_cv column.'); }
catch (e) { console.log('master_cv:', e.message); }
