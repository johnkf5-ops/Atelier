...
*Last updated 2026-04-25 for the 2026-04-26 8:00 PM EST submission deadline. See `README.md` for setup, `ARCHITECTURE.md` for the technical architecture deep-dive, `BUILD_LOG.md` for the chronological build narrative, `WALKTHROUGH_NOTES.md` for the production-bug walkthrough, and `skills/README.md` for the skill-file catalog.*
